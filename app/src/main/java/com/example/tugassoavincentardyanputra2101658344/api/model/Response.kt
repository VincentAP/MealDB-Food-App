package com.example.tugassoavincentardyanputra2101658344.api.model

import com.google.gson.annotations.SerializedName

data class MealBaseResponse(
...
data class MealCategoryResponse(
    @SerializedName("categories") val categories: List<MealCategoryItemResponse>?
)

data class MealCategoryItemResponse(
...
data class MealByFilterResponse(
    @SerializedName("meals") val meals: List<MealByFilterItemResponse>?
)

data class MealByFilterItemResponse(
    @SerializedName("strMeal") val strMeal: String?,
    @SerializedName("strMealThumb") val strMealThumb: String?,
    @SerializedName("idMeal") val idMeal: String?
)

data class MealCategoryFilterResponse(
    @SerializedName("meals") val meals: List<MealCategoryFilterItemResponse>?
)

data class MealCategoryFilterItemResponse(
    @SerializedName("strCategory") val strCategory: String?
)

data class MealAreaFilterResponse(
    @SerializedName("meals") val meals: List<MealAreaFilterItemResponse>?
)

data class MealAreaFilterItemResponse(
    @SerializedName("strArea") val strArea: String?
)

data class MealIngredientsFilterResponse(
    @SerializedName("meals") val meals: List<MealIngredientsFilterItemResponse>?
)

data class MealIngredientsFilterItemResponse(
